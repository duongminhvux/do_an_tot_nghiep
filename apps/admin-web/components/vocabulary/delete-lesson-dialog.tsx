        ...
        <div className="flex items-start gap-4">
          ...
          <div className="space-y-1.5 flex-1 pr-2">
            <DialogTitle className="text-base font-bold text-slate-900">
              {t('delete_lesson_title', { defaultValue: 'Confirm Delete Lesson' })}
            </DialogTitle>
            <DialogDescription className="text-xs text-slate-500 leading-relaxed">
              {t('delete_lesson_desc', {
                title: lesson?.title || '',
                defaultValue: `Are you sure you want to delete lesson "${lesson?.title}"? Words inside will remain in the vocabulary dictionary.`,
              })}
            </DialogDescription>
          </div>
        </div>
