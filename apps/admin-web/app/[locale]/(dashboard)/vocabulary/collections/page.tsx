...
export default function CollectionsPage() {
  ...
  // Auto-select first collection if none selected or current was removed
  useEffect(() => {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 space-y-6 w-full max-w-[1600px] mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-4 xl:col-span-3 rounded-2xl border border-slate-200 bg-white p-4 space-y-3 shadow-xs">
          {/* Search Collections */}
              ...
              collections.map((col, idx) => {
                ...
                return (
                  <div
                    ...
                    className={`group flex items-center justify-between gap-2 p-2.5 rounded-xl border transition-all duration-150 cursor-pointer ${
                      isDragging
        ...
        <div className="lg:col-span-8 xl:col-span-9 rounded-2xl border border-slate-200 bg-white p-6 shadow-xs space-y-6">
          {currentCollection ? (
            <>
                              ...
                              <div className="min-w-0 flex-1">
                                <div className="flex items-center gap-2 flex-wrap">
                                  ...
                                  <button
                                    ...
                                    title={t('click_to_toggle_status', { defaultValue: 'Click to toggle active status' })}
                                    className={`inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-semibold border transition-all cursor-pointer ${
                                      l.isActive !== false
                                        ? 'bg-emerald-50 text-emerald-700 border-emerald-200 hover:bg-emerald-100'
      ...
      <LessonWordsDialog
        ...
        onOpenChange={(v) => {
          if (!v) setManagingWordsLesson(null);
        }}
      />
    </div>
  );
